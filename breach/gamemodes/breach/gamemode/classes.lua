	...
	security = {
		...
		roles = {
			...
			{name = ROLES.ROLE_MTFGUARD,
			 team = TEAM_GUARD,
			 weapons = {"br_holster", "br_id", "keycard_level4", "item_radio", "weapon_stunstick", "cw_mp5"},
			 showweapons = {"Keycard Level 4", "Radio", "Stunstick", "UMP .45"},
			 ammo = {},
			 health = 100,
			 armor = 0,
			 walkspeed = 0.85,
			...
			{name = ROLES.ROLE_CHAOSSPY,
			 team = TEAM_CHAOS,
			 weapons = {"br_holster", "br_id", "keycard_level4", "item_radio", "weapon_stunstick", "cw_ump45"},
			 showweapons = {"Keycard Level 4", "Radio", "Stunstick", "UMP .45"},
			 ammo = {},
			 health = 100,
			 armor = 0,
			...
			{name = ROLES.ROLE_CSECURITY,
			 ...
			 showweapons = {"Keycard Level 4", "Radio", "Camera View", "Stunstick", "MP5"},
			 ammo = {},
			 health = 100,
			 armor = 0,
			 walkspeed = 0.9,
			...
			{name = ROLES.ROLE_MTFMEDIC,
			 ...
			 showweapons = {"Keycard Level 4", "Radio", "Medkit", "Stunstick", "UMP .45"},
			 ammo = {},
			 health = 100,
			 armor = 0,
			 walkspeed = 0.85,
			...
			{name = ROLES.ROLE_HAZMAT,
			 ...
			 showweapons = {"Keycard Level 4", "Radio", "NVG", "Camera View", "Stunstick", "SCAR-H"},
			 ammo = {},
			 health = 125,
			 armor = 50,
			 walkspeed = 0.93,
	...
	support = {
		...
		roles = {
			{name = ROLES.ROLE_MTFNTF,
			 ...
			 showweapons = {"Keycard Level 4", "Radio", "NVG", "Stunstick", "G36C"},
			 ammo = {},
			 health = 100,
			 armor = 0,
			 walkspeed = 0.86,
